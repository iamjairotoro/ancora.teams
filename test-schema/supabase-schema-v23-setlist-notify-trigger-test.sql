...
begin
  ...
  if last_notified is null or now() - last_notified >= interval '3 minutes' then
    ...
    -- VERSIÓN DE PRUEBA: comentado para que un INSERT/UPDATE/DELETE en esta
    -- base de prueba no dispare una llamada HTTP real contra la app de
    -- producción. Se deja comentado (no borrado) para poder ver exactamente
